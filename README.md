...
In the keywords.json file, are all the keywords it can answer.
In authentification directory are all files for authentification, include json databases.
In keywords directory are all keywords, wich code is longer then one line.
